...
const AnimatedLockBot = ({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      {withSpeechBubble && (
        <div 
          className="relative mb-6 bg-[#121A2F] p-4 rounded-xl shadow-lg border border-[#293659]/50 cursor-pointer"
        ...
        >
          ...
          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[8px] border-l-transparent border-t-[8px] border-t-[#121A2F] border-r-[8px] border-r-transparent"></div>
        </div>
      )}
